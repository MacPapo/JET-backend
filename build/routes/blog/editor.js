...
/*-------------------------------------------------------------------------*/
router.use(authentication_1.default, (0, role_1.default)(Role_1.RoleCode.ADMIN, Role_1.RoleCode.COOKER), authorization_1.default);
/*-------------------------------------------------------------------------*/
router.put('/publish/:id', (0, validator_1.default)(schema_1.default.blogId, validator_1.ValidationSource.PARAM), (0, asyncHandler_1.default)(async (req, res) => {
...
router.put('/unpublish/:id', (0, validator_1.default)(schema_1.default.blogId, validator_1.ValidationSource.PARAM), (0, asyncHandler_1.default)(async (req, res) => {
    const blog = await BlogRepo_1.default.findBlogAllDataById(new mongoose_1.Types.ObjectId(req.params.id));
    if (!blog)
        throw new ApiError_1.BadRequestError('Blog does not exists');
    blog.isDraft = true;
