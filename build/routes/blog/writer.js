...
/*-------------------------------------------------------------------------*/
router.use(authentication_1.default, (0, role_1.default)(Role_1.RoleCode.BARTENDER), authorization_1.default);
/*-------------------------------------------------------------------------*/
const formatEndpoint = (endpoint) => endpoint.replace(/\s/g, '').replace(/\//g, '-').replace(/\?/g, '');
router.post('/', (0, validator_1.default)(schema_1.default.blogCreate), (0, asyncHandler_1.default)(async (req, res) => {
...
router.put('/id/:id', (0, validator_1.default)(schema_1.default.blogId, validator_1.ValidationSource.PARAM), (0, validator_1.default)(schema_1.default.blogUpdate), (0, asyncHandler_1.default)(async (req, res) => {
...
router.put('/submit/:id', (0, validator_1.default)(schema_1.default.blogId, validator_1.ValidationSource.PARAM), (0, asyncHandler_1.default)(async (req, res) => {
    const blog = await BlogRepo_1.default.findBlogAllDataById(new mongoose_1.Types.ObjectId(req.params.id));
    if (!blog)
        throw new ApiError_1.BadRequestError('Blog does not exists');
    if (!blog.author._id.equals(req.user._id))
...
router.put('/withdraw/:id', (0, validator_1.default)(schema_1.default.blogId, validator_1.ValidationSource.PARAM), (0, asyncHandler_1.default)(async (req, res) => {
    const blog = await BlogRepo_1.default.findBlogAllDataById(new mongoose_1.Types.ObjectId(req.params.id));
    if (!blog)
        throw new ApiError_1.BadRequestError('Blog does not exists');
    if (!blog.author._id.equals(req.user._id))
...
router.delete('/id/:id', (0, validator_1.default)(schema_1.default.blogId, validator_1.ValidationSource.PARAM), (0, asyncHandler_1.default)(async (req, res) => {
    const blog = await BlogRepo_1.default.findBlogAllDataById(new mongoose_1.Types.ObjectId(req.params.id));
    if (!blog)
        throw new ApiError_1.BadRequestError('Blog does not exists');
    if (!blog.author._id.equals(req.user._id))
...
router.get('/submitted/all', (0, asyncHandler_1.default)(async (req, res) => {
...
router.get('/published/all', (0, asyncHandler_1.default)(async (req, res) => {
    const blogs = await BlogRepo_1.default.findAllPublishedForWriter(req.user);
    return new ApiResponse_1.SuccessResponse('success', blogs).send(res);
}));
router.get('/drafts/all', (0, asyncHandler_1.default)(async (req, res) => {
